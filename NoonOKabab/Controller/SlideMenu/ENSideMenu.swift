...
open class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    fileprivate var outterView : UIView!
    ...
    */
    public init(sourceView: UIView, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffect.Style = .systemUltraThinMaterialLight) {
        super.init()
        ...
        outterView = UIView(frame: CGRect(x:sideMenuContainerView.frame.width, y:0,
                                              width:sourceView.frame.width - sideMenuContainerView.frame.width,
                                              height:sourceView.frame.height))
